...
editsummary = {
    ...
    "la":"[[Usor:Addbot|Addbot]] $counter nexus intervicos removet, quod nunc apud [[d:|Vicidatam]] cum tessera [[d:$id]] sunt",
    ...
    "bg":"Робот: Преместване на $counter междуезикови препратки, вече съхранявани от [http://www.wikidata.org/wiki/Wikidata:Main_Page Уикиданни], в [[d:$id]] ",
    ...
    "bn":"[[ব্যবহারকারী:Addbot|বট]]: $counter টি আন্তঃউইকি সংযোগ সরিয়ে নেওয়া হয়েছে, যা এখন [[d:Wikidata:প্রধান পাতা|উইকিউপাত্তের]] - [[d:$id]] এ রয়েছে",
    "de":"Verschiebe $counter [[Hilfe:Internationalisierung|Interlanguage-Links]] nach [[Wikipedia:Wikidata|Wikidata]] nach [[d:$id]]",
    ...
    "ka":"[[User:Addbot|Bot:]] $counter [[ვპ:ებ|ენათაშორისი ბმული]] გადატანილია [[Wikipedia:Wikidata|Wikidata]]_ზე, [[d:$id]]",
